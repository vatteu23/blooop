...
import {
  ...
  getProjects,
  getProjectsPending,
  getProjectsOrderKeys,
} from "../js/reducers/projectsReducer";
        ...
        <div className="content">
          <div className="container mt-4">
            <div className="d-flex flex-row flex-wrap justify-content-center">
              <h2 className="gradient-text align-self-center mr-md-auto mt-3 mb-0">
                Work and Projects
              </h2>
              <a
                className="btn btn-primary ml-md-auto mt-3 align-self-center"
